  ...
  <div class="col-md-4">
    <div class="thumbnail">
      <a href="/product/detail/${p.id}" width="192px" height="180px">
        ...
        <button class="btn btn-sm btn-info btn-sent" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-envelope"></i></button>
        </div>
         <p>${p.name}</p>
          <p>${p.unitPrice}</p>
        </div>
...
<img class ="estore" src="/static/ảnh mạng/mess.png">
